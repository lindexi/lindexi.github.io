...
![](http://7xqpl8.com1.z0.glb.clouddn.com/lindexi%2F20186151539553983.jpg)
...
在软件启动的时候，还有一个读取文件是加载库，如果我使用了第三方的 dll ，那么在启动的时候我就需要加载这个 dll ，但是我读取的配置文件只有不到 100 k 但是我加载的几个库都是很大。

![](http://7xqpl8.com1.z0.glb.clouddn.com/lindexi%2F20186151548345847.jpg)
