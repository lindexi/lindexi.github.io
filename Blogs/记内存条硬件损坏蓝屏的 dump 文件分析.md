...
description: 本文记录我的电脑的内存条的硬件损坏了，导致用着用着就蓝屏，我通过启动和故障恢复配置自动蓝屏打 dump 的功能，在蓝屏时创建了 dump 文件。通过分析 dump 文件大概猜测是内存的问题
tags: 
category: 
---
...
![](https://img2024.cnblogs.com/blog/1080237/202508/1080237-20250810094931151-1945580354.png)
